...
if  (lengthScale === 1.99)
{
	const speakers = ["埃德_ZH", "塔杰·拉德卡尼_ZH", "行秋_ZH", "深渊使徒_ZH", "凯瑟琳_ZH", "常九爷_ZH", "神里绫人_ZH", "丽莎_ZH", "纯水精灵?_ZH", "宛烟_ZH", "重云_ZH", "悦_ZH", "莱依拉_ZH", "鹿野奈奈_ZH",
...
{
	const speakers = ['特别周', '无声铃鹿', '东海帝皇（帝宝，帝王）', '丸善斯基', '富士奇迹',
